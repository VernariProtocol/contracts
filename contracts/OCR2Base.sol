...
import "@chainlink/src/v0.8/dev/ocr2/OCR2Abstract.sol";
...
abstract contract OCR2Base is ConfirmedOwner, OCR2Abstract {
    ...
    */
     ...
     */
    function _validateReport(bytes32 configDigest, uint40 epochAndRound, bytes memory report)
        internal
        virtual
        returns (bool);
    ...
    function requireExpectedMsgDataLength(bytes calldata report, bytes32[] calldata rs, bytes32[] calldata ss)
        private
        pure
    {
